    ...
    return (
        <div className={styles.aboutContainer}>
            ...
            <div className={styles['aboutCareer']}>
                <h1>Career</h1>
                <p>I graduated from Oregon State University on December 20th, 2020 with a bachelor's of science in Computer Science.<br/>I also minored in Mathematics.</p><br/>
